...
- Data transfer: Due to the large number and size of the files, the datasets were first downloaded within a DNAnexus JupyterLab/workstation session and then uploaded to the shared project directory. The upload was performed through the `JupyterLab_data_upload_test` job by `user-yunjialiusv`.
